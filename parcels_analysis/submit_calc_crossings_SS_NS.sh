#!/bin/bash
#SBATCH -J xrcrSSNS          # name of the job
...
#SBATCH -o logfiles/calc_crossings_SS_NS_2024.out     # name of the output file (=stuff you normally see on screen)
#SBATCH -e logfiles/calc_crossings_SS_NS_2024.err     # name of the error file (if there are errors)
...
for combo in "${combinations[@]}"; do
    ...
    python -u 2_calc_crossings_SS_NS.py $yr $mnt > logfiles/calc_crossings_SS_NS_Y${yr}M${mnt}.log 2>&1 &
done
